...
@interface BDFeedbackViewController ()<BDFormContentViewCellDelegate, BDFormPhoneViewCellDelegate, BDFormEmailViewCellDelegate, BDFormSubmitViewCellDelegate, QMUIAlbumViewControllerDelegate,QMUIImagePickerViewControllerDelegate,BDSingleImagePickerPreviewViewControllerDelegate>
...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"我的反馈" style:UIBarButtonItemStylePlain target:self action:@selector(showMyTickets)];
