...
- (void)viewDidLoad {
    ...
    // Uncomment the following line to display an Edit button in the navigation bar for this view controller.
     self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"我的工单" style:UIBarButtonItemStylePlain target:self action:@selector(showMyTickets)];
...
- (void)showMyTickets {
    //
    BDTicketRecordViewController *bdTicketRecordVC = [[BDTicketRecordViewController alloc] init];
    [self.navigationController pushViewController:bdTicketRecordVC animated:YES];
}
