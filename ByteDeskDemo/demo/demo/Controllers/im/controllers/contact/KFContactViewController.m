...
@implementation KFRosterSearchView
...
@interface KFContactViewController ()<QMUISearchControllerDelegate, MGSwipeTableCellDelegate>
...
@implementation KFContactViewController
...
//    self.navigationItem.rightBarButtonItem = [UIBarButtonItem qmui_itemWithImage:UIImageMake(@"icon_nav_more") target:self action:@selector(handleTopRightButtonClickEvent)];
    ...
    self.mySearchController.launchView = [[KFRosterSearchView alloc] init];// launchView 会自动布局，无需处理 frame
