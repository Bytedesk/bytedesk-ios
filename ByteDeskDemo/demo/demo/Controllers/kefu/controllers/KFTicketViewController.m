...
@interface KFTicketViewController ()<KFFormContentViewCellDelegate, KFFormPhoneViewCellDelegate, KFFormEmailViewCellDelegate, KFFormSubmitViewCellDelegate, QMUIAlbumViewControllerDelegate,QMUIImagePickerViewControllerDelegate,QDSingleImagePickerPreviewViewControllerDelegate>
...
- (void)submitButtonClicked:(id)sender {
    ...
    [BDCoreApis createTicket:DEFAULT_TEST_ADMIN_UID
...
- (void)getTicketCategories {
    ...
    [BDCoreApis getTicketCategories:DEFAULT_TEST_ADMIN_UID resultSuccess:^(NSDictionary *dict) {
