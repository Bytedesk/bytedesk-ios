...
@class BD_MLAudioMeterObserver;

typedef void (^MLAudioMeterObserverActionBlock)(NSArray *levelMeterStates,BD_MLAudioMeterObserver *meterObserver);
typedef void (^MLAudioMeterObserverErrorBlock)(NSError *error,BD_MLAudioMeterObserver *meterObserver);
...
@interface BD_MLAudioMeterObserver : NSObject
{
