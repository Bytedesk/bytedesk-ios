...
//! Project version number for bdui.
FOUNDATION_EXPORT double bduiVersionNumber;

//! Project version string for bdui.
FOUNDATION_EXPORT const unsigned char bduiVersionString[];
